DELIMITER //
CREATE  PROCEDURE sp_get_vacantes_estadia(perfil int, json_conocimiento varchar(65000), 
...
CREATE  PROCEDURE sp_get_vacantes_egresados(perfil int, json_conocimiento varchar(65000), 
	json_habilidades varchar(65000))
BEGIN
	DECLARE json_items int ;   
	DECLARE json_items2 int ;  
