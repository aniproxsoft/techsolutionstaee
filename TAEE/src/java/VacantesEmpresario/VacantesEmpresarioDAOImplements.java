 ...
 * @author ANIPROXTOART
 */
public class VacantesEmpresarioDAOImplements implements VacantesEmpresarioDAO {
    ...
    public List<VacanteVO> getVacantesEmpresario(int empresa_id) {
        ...
        try {
            ...
            CallableStatement query = conn.prepareCall("{call sp_get_vacantes_usuario(?)}");
    ...
    public boolean deleteVacanteEmpresario(int vacante_id) {
        ...
        try {
            ...
            conexion = new ConnectionDB();
            conn = conexion.conectarBD();
            CallableStatement query = conn.prepareCall("{call sp_delete_vacante_egresados(?)}");
